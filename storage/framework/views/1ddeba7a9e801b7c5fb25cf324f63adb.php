...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css\contacto.css')); ?>">
</head>
<body>
    <div id="header">
        <div id="logo">
    ...
    <div class="info">
        ...
        <div class="card">
            <div class="card-info">
                ...
                <div class="card-title">M.C. María del Carmen Santiago Díaz</div>
                <div class="card-subtitle">Maestra</div>
            </div>
            <div class="main">
                <div class="up">
                    <button class="card10">
                        <a href="https://www.youtube.com/watch?v=Eavoch9USHE" target="_blank">
        ...
        <div class="card2">
            <div class="card2-info">
                ...
                <div class="card2-subtitle">Maestro</div>
            </div>
            <div class="main">
                <div class="up">
                    <button class="card12">
    ...
    <div class="info2">
        ...
        <div class="card4">
            <div class="card4-info">
                ...
                <div class="card4-title">Roberto Carlos Hernandez Aparicio</div>
                <div class="card4-subtitle">Equipo Selene</div>
            </div>
            <div class="main">
                <div class="up">
                    <button class="card16">
        ...
        <div class="card5">
            <div class="card5-info">
                ...
                <div class="card5-title">Nombre del otro integrante</div>
                <div class="card5-subtitle">Equipo Rebells</div>
            </div>
            <div class="main">
                <div class="up">
                    <button class="card18">
    ...
    <?php /**PATH C:\xampp\htdocs\example-app\resources\views/Contacto.blade.php ENDPATH**/ ?>